...
client.on('guildCreate', guild => {
   const botownerid = "903492864535838740";
   const botownerid2 = "903492864535838740";
   const serverjoinch = client.channels.cache.get("982507789337370674")
   //const botownerfix = client.users.fetch(botownerid);
   const botowner = client.users.cache.get("903492864535838740");
   const botowner2 = client.users.cache.get("903492864535838740");
...
client.on('guildDelete', guild => {
  const owneridforleave = '903492864535838740';
  const owneridforleave2 = "903492864535838740";
  const serverleavech = client.channels.cache.get("903492864535838740")
